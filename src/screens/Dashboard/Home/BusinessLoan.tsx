...
const BusinessLoanScreen = ({ navigation }: any) => {
  ...
  const loanData = [
    { id: 1, title: 'Loan1', loanType: 'Business Loan', principleRange: '1L - 5L', ROI: '10%', AgeCriteria: '10-20  Years' },
    { id: 2, title: 'Loan2', loanType: 'xyz Loan', principleRange: '5L - 50L', ROI: '8%', AgeCriteria: '10-20 Years' },
    { id: 3, title: 'Loan3', loanType: 'abc Loan', principleRange: '1L - 20L', ROI: '12%', AgeCriteria: '10-20  Years' },
  ];
